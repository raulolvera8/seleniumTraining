...
public class Supplier_CreateTourTestNG_ClassWtParameters extends Driver {
	...
	@Test(dataProvider = "dataTour", dataProviderClass = ParameterDataprovider.class)
	public void Supplier_CreateTourScript(String email, String password, String tourName, String tourDesc,
			String adultQty, String adultPrice, String locationTour, String metaTitle, String metaKeywords,
			String metaDesc, String paymentOption, String policyAndTerms, String tourEmail, String tourWebsite,
			String tourPhone, String tourAddress, String tourHours, String tourDays, String tourNights,
			String tourType) {
