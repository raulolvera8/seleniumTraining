...
public class PTCustomerPageObject {
	...
	@FindBy(xpath = "//*[@class='dropdown-item adult_qty']//*[@class='qtyInc']")
	WebElement iconPlus;
	@FindBy(xpath = "//*[@class='guest_flights']")
	WebElement numberPassengers;
	@FindBy(id = "flights-search")
	WebElement flightsSearchBtn;
	...
	public void selectItemFlyingFrom() {
		List<WebElement> listFlyingFrom = driver.findElements(
	...
	public void selectItemToDestination() {
		List<WebElement> listToDestination = driver.findElements(
	...
	/*
	 * public void numberOfPassengers() throws InterruptedException { int i; for (
	 * i=0; i <=1; i++) { clickIconPlus(); Thread.sleep(3000); } }
	 */
	...
	/// ---- BOOK NOW WINDOW
	@FindBy(xpath = "//*[@class='theme-search-results-item-book row']")
	...
	public void clickBookNowBtn() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//h3[@class='title'][contains(text(), 'Your Personal Information')]")));
	 ...
	 * 
	 * @FindBy(name="passport_issuance_month_1") WebElement
	 * dropDown_passport_issuance_month;
	 * 
	 * @FindBy(name="passport_issuance_day_1") WebElement
	 * dropDown_passport_issuance_day;
	 * 
	 * @FindBy(name="passport_issuance_year_1") WebElement
	 * DropDown_passport_issuance_year_1;
	 * 
	 ...
	 * 
	 * @FindBy (xpath="//*[@class='col-md-12 mb-1 gateway_pay-later']") WebElement
	 * payLaterRadioBtn;
	 * 
	 * @FindBy (xpath="//*[@class='custom-checkbox']") WebElement
	 ...
	 * 
	 * public WebElement getFirstNametb() { return firstNametb; } public void
	 * writefirstNametb(String firstName) { getFirstNametb().sendKeys(firstName); }
	 * public WebElement getlastNametb() { return lastNametb; } public void
	 * writelastNametb(String lastName) { getlastNametb().sendKeys(lastName); } //
	 * ---- DROPDOWN LIST -------
	 * 
	 * // ----- NATIONALITY public WebElement getdropdownNationality() { return
	 * dropdownNationality; } public void clickDropdownNationality() {
	 * getdropdownNationality().click(); } public void selectValueNationality() {
	 * List <WebElement> listNationality = driver.findElements(By.
	 * xpath("//*[@class='form-select form-select-sm nationality']//option"));
	 * listNationality.get(5).click(); } // ----- TITLE
	 * 
	 * public WebElement getDropDowntitle() { return DropDowntitle; } public void
	 * selectDropDowntitle() { getDropDowntitle().click(); } public void
	 * selectValueTitle() { List <WebElement> listTitle =
	 * driver.findElements(By.xpath("//*[@name='title_1']//option"));
	 * listTitle.get(1).click(); } // ----- NATIONALITY_01
	 * 
	 * public WebElement getDropDownNationality_1() { return DropDownNationality_1;
	 * } public void selectDropDownNationality_1() {
	 * getDropDownNationality_1().click(); } public void selectValueNationality_1()
	 * { List <WebElement> listNationality_1 =
	 * driver.findElements(By.xpath("//*[@name='nationality_1']//option"));
	 * listNationality_1.get(5).click(); } // ----- DATE OF BIRTH
	 * 
	 * public WebElement getDropDownMonth() { return DropDownMonth; } public void
	 * selectDropDownMonth() { getDropDownMonth().click(); }
	 * 
	 * public void selectDateOfBirth() { List <WebElement> listMonth =
	 * driver.findElements(By.xpath("//*[@name='dob_month_1']//option"));
	 * listMonth.get(5).click(); }
	 * 
	 * // ----- DAY
	 * 
	 * public WebElement getDropDownDay() { return DropDownDay; } public void
	 * selectDropDownDay() { getDropDownDay().click(); }
	 * 
	 * public void selectDay() { List <WebElement> listDay =
	 * driver.findElements(By.xpath("//*[@name='dob_day_1']//option"));
	 * listDay.get(10).click(); }
	 * 
	 * // ----- YEAR
	 * 
	 * public WebElement getDropDownYear() { return DropDownYear; } public void
	 * selectDropDownYear() { getDropDownYear().click(); } public void selectYear()
	 * { List <WebElement> listYear =
	 * driver.findElements(By.xpath("//*[@name='dob_year_1']//option"));
	 * listYear.get(5).click(); } // ---- END DROPDOWN LIST -------
	 * 
	 * //----- PASSPORT DATA ------ // Passport Issuance Date public WebElement
	 * getPassport() { return passportTb; } public void writePassport(String
	 * passport) { getPassport().sendKeys(passport); } // --select Passport Month
	 * public WebElement getPassportMonth() { return
	 * dropDown_passport_issuance_month; } public void selectPassportMonth() {
	 * getPassportMonth().click(); } public void itemPassportMonth() { List
	 * <WebElement> listPassportMonth =
	 * driver.findElements(By.xpath("//*[@name='passport_issuance_month_1']//option"
	 * )); listPassportMonth.get(5).click(); } // -- Select Passport Day public
	 * WebElement getPassportDay() { return dropDown_passport_issuance_day; } public
	 * void selectPassportDay() { getPassportDay().click(); } public void
	 * itemPassportDay() { List <WebElement> ListPassportDay =
	 * driver.findElements(By.xpath("//*[@name='passport_issuance_day_1']//option"))
	 * ; ListPassportDay.get(5).click(); } // --- Select Passport Year public
	 * WebElement getPassportYear() { return DropDown_passport_issuance_year_1; }
	 * public void selectPassportYear() { getPassportYear().click(); } public void
	 * itemPassportYear() { List <WebElement> ListPassportYear =
	 * driver.findElements(By.xpath("//*[@name='passport_issuance_year_1']//option")
	 * ); ListPassportYear.get(5).click(); } /// Passport Expiry Date // --- Expiry
	 * Month public WebElement getExpiryMonth() { return dropDown_passport_month_1;
	 * } public void selectExpiryMonth() { getExpiryMonth().click(); } public void
	 * itemExpiryMonth() { List <WebElement> listExpiryMonth =
	 * driver.findElements(By.xpath("//*[@name='passport_month_1']//option"));
	 * listExpiryMonth.get(5).click(); } // --- Expiry Day public WebElement
	 * getExpiryDay() { return dropDown_passport_day_1; } public void
	 * selectExpiryDay() { getExpiryDay().click(); } public void itemExpiryDay() {
	 * List <WebElement> listExpiryDay =
	 * driver.findElements(By.xpath("//*[@name='passport_day_1']//option"));
	 * listExpiryDay.get(5).click(); } // --- Expiry Year public WebElement
	 * getExpiryYear() { return DropDown_passport_year_1; } public void
	 * selectExpiryYear() { getExpiryYear().click(); } public void itemExpiryYear()
	 * { List <WebElement> listExpiryYear =
	 * driver.findElements(By.xpath("//*[@name='passport_year_1']//option"));
	 * listExpiryYear.get(5).click(); }
	 * 
	 * 
	 * // PAY LATER public WebElement getPayLaterRadioBtn() { return
	 * payLaterRadioBtn; } public void selectPayLaterRadioBtn() {
	 * getPayLaterRadioBtn().click(); } // ACCEPT TERMS AND CONDITIONS
	 * termsAndConditionsCheckBoxbookingBtn public WebElement getCheckboxTerms() {
	 * return termsAndConditionsCheckBox; } public void selectCheckBoxTerms() {
	 * getCheckboxTerms().click(); } // CONFIRM BOOKING BTN public WebElement
	 * getBookingBtn() { return bookingBtn; }
	 * 
	 * public void clickBookingBtn() { getBookingBtn().click(); Wait<WebDriver>
	 * wait2 = new
	 ...
	 * "//div[@id='preloader']"), "style", "display: none;")); Wait<WebDriver> wait
	...
	/*
	 * //------ VALIDATION WINDOW ------ // ---- Booking status
	 * 
	 * @FindBy
	 * (xpath="//div[@class='infobox infobox-danger'][contains(.,'Your booking status is ( Pending ) and payment status is pay later ( Unpaid )')]"
	 * ) WebElement paymentStatusStripe;
	 * 
	 * @FindBy
	 * (xpath="//div[@class='infobox infobox-warning'][contains(.,'Your booking status is ( Pending ) and payment status is pay later ( Unpaid )')]"
	 * ) WebElement paymentStatusPLater;
	 * 
	 * @FindBy (xpath =
	 * "//*[@class='card-body'][contains(.,'Miss Diana Velasquez ')]") WebElement
	 * travellerDetails;
	 * 
	 * @FindBy (xpath="//li[contains(.,'user@phptravels.com')]") WebElement
	 * reservationNumber; public void validationStatusStripe() {
	 * System.out.println("BOOKING INVOICE WINDOW"); if
	 * (reservationNumber.getText().contentEquals("Email: user@phptravels.com")) {
	 * System.out.println(paymentStatusStripe.getText());
	 * System.out.println(travellerDetails.getText());
	 * System.out.println(reservationNumber.getText()); } else { Assert.fail(
	 * "FAILED" ); } }
	 * 
	...
	/*
	 * @FindBy(xpath="//*[@href='https://phptravels.net/tours']") WebElement
	 * toursBtn;
	 * 
	 * public WebElement getToursBtn() { return toursBtn;
	 * 
	 * }
	 * 
	 ...
	 * 
	 * 
	 * public void writeCountry(String fromDestination) { Wait<WebDriver> wait = new
	 * FluentWait<WebDriver>(this.driver).withTimeout(Duration.ofSeconds(60))
	 * .pollingEvery(Duration.ofSeconds(3)).ignoring(ElementNotInteractableException
	 * .class);
	 * 
	 ...
	 * "//*[text()='Destination']")));
	 * 
	 * System.out.println("typing Dubai"); getCardName().sendKeys(fromDestination);
	 * } private WebElement getCardName() { return writeCountry;
	 * 
	 * 
	 * 
	 * 
	 ...
	 * 
	 * public WebElement getDateTour() { return dateTour;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * }
	 * 
	 * public WebElement getDateSelect() { return dateSelect; }
	 * 
	 ...
	 * 
	 * @FindBy(xpath="//*[@id='adults']//option[@value='1']") WebElement
	 * adultsNumber;
	 * 
	 * 
	 * 
	 ...
	 * 
	 * 
	 * public WebElement getAdultsNumber() { return adultsNumber;
	 * 
	 * }
	 * 
	 ...
	 * 
	 * @FindBy(xpath="//*[@id='childs']//option[@value='1']") WebElement
	 * childsNumber;
	 * 
	 * 
	 * 
	 * public WebElement getChilds() { return childs;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * }
	 * 
	 * public WebElement getChildsNumber() { return childsNumber;
	 * 
	 * }
	 * 
	 ...
	 * 
	 * @FindBy(xpath="//*[@id='infants']//option[@value='1']") WebElement
	 * infantsNumber;
	 * 
	 * 
	 * 
	 * public WebElement getInfants() { return infants;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * 
	 * 
	 * public WebElement getInfantsNumber() { return infantsNumber;
	 * 
	 * }
	 * 
	 ...
	 * 
	 * public WebElement getBookNowDate() { return bookNowDate;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * //TRAVELLER 1
	 * 
	 * @FindBy(xpath="//*[@name='title_1']//option[@value='Mrs']") WebElement
	 * traveller1;
	 * 
	 ...
	 * 
	 * 
	 * public WebElement getTraveller1() { return traveller1;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * 
	 * 
	 * } public WebElement getFirstName1() { return firstName1; }
	 * 
	 * 
	 ...
	 * ("//*[text()='Tour Booking']")));
	 * 
	 * } public WebElement getLastName1() { return lastName1; }
	 * 
	 * 
	 ...
	 * //TRAVELLER 2
	 * 
	 * @FindBy(xpath="//*[@name='title_2']//option[@value='Miss']") WebElement
	 * traveller2;
	 * 
	 ...
	 * 
	 * 
	 * public WebElement getTraveller2() { return traveller2;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * 
	 * 
	 * } public WebElement getFirstName2() { return firstName2; }
	 * 
	 * 
	 ...
	 * ("//*[text()='Tour Booking']")));
	 * 
	 * } public WebElement getLastName2() { return lastName2; }
	 * 
	 * 
	 ...
	 * //TRAVELLER 3
	 * 
	 * @FindBy(xpath="//*[@name='title_3']//option[@value='Mr']") WebElement
	 * traveller3;
	 * 
	 ...
	 * 
	 * 
	 * public WebElement getTraveller3() { return traveller3;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * 
	 * 
	 * } public WebElement getFirstName3() { return firstName3; }
	 * 
	 * 
	 ...
	 * ("//*[text()='Tour Booking']")));
	 * 
	 * } public WebElement getLastName3() { return lastName3; }
	 * 
	 * 
	 ...
	 * 
	 * public WebElement getContinuing() { return checkboxContinuing;
	 * 
	 * 
	 * }
	 * 
	 ...
	 * 
	 * public WebElement getconfirm() { return confirmBooking;
	 * 
	 * 
	 * }
	 * 
...
//MODIFY SEARCH
	...
	@FindBy(xpath = "//*[@class='theme-search-results-item-preview']")
	WebElement verifyStops;
