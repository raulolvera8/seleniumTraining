...
//------my account button-----
@FindBy (xpath="//div[@class='dn db-hdkp relative']") WebElement cuentaBtn;
...
public void elementoCuenta() {
	...
	wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='absolute bg-white br3 br--bottom left-0 lh-copy mt3 overflow-hidden shadow-1']")));
	...
	waits.until(ExpectedConditions.attributeToBe(By.xpath("//*[@class='dn db-hdkp relative']//*[@class='flex items-center no-underline ph3 white desktop-header-trigger lh-title lh-solid']"), "aria-expanded", "true"));

	System.out.println("Clicking Cuenta Button");
	}

//------Log in----
@FindBy (xpath="//*[@class='w_AX w_AZ w_Ad db mb3 w-100']") WebElement iniciarSesionBtn;
...
@FindBy (xpath="//*[@class='w_GM w_GP']") WebElement closePopup;
@FindBy (xpath="//*[@class='w_JG']") WebElement closeBtnPopPup;
